...
const HomeUserPanel = defineComponent({
  setup() {
    ...
    return () => (
      <div class="block-item user-panel">
...
const HomeJobRecommend = defineComponent({
  setup() {
    ...
    return () => (
      <div class="block-item job-recommend">
...
<template>
  <div class="home-page">
    <Component :is="HomeTour()" />
    <Component :is="HomeBackground()" />
    <Component :is="HomeMask()" />
    <Component :is="HomeBottom" />
    <!--    <HomeTour />-->
    <!--    <HomeBackground />-->
    <!--    <HomeMask />-->
    <!--    <HomeBottom />-->
